      ...
      <div className="hero is-fullheight">
        <div className="hero-body">
          <div className="container">
            { data && !error && !loading &&
              <>
                <h1 className="title is-1 has-text-centered">{data.name}, {data.country} seems nice at the moment!</h1>
                ...
                <div className="go-buttons">
                  ...
                  <button onClick={fetchForecast} className="button is-info is-medium">
                    What else you got?
                  </button>
                </div>
              </>
            }
            {loading && <h2 className="title has-text-centered">
              searching...
            </h2>}
            {error && <h2 className="title has-text-centered">
              Oops, I did it again...
            </h2>}
          </div>
        </div>
